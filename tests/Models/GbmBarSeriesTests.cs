...
public class GbmBarSeriesTests
{
    ...
    {        // Arrange
        ...
        Assert.True(bar.Open > 0.5m && bar.Open < 2.0m, "Open should be in expected GBM range");
    ...
    public void Generator_DirectAccess_WorksCorrectly()
    {
        ...
        var generator = new GbmBarSeries.Generator(symbol, seed, interval, 0.0001, 0.01);
